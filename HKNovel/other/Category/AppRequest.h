...
+(void)getRequestInURL:(NSString *)url andParameters:(NSDictionary *)parameters succes:(void (^)(id responseObject))success stateerror:(void (^)(id responseObject))stateerror error:(void (^)(NSError *error))error1 controller:(UIViewController *)controller1;
@end
